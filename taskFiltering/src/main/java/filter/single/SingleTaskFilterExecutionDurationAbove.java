...
public class SingleTaskFilterExecutionDurationAbove implements SingleTaskResultFilter {
  ...
  public void setDurationFilter(Duration durationFilterAbove) {
    durationFilter = Optional.ofNullable(durationFilterAbove);
  }
}
